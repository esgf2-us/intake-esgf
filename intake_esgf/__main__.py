...
if __name__ == "__main__":
    sentences = [
        ...
        ">>> cat.search(project='CMIP6',experiment_id='historical',source_id='CanESM5',variable_id=['pr','tas'],frequency='mon')",
        ...
        ">>> cat.search(project='CMIP6',experiment_id='historical',source_id='CanESM5',variable_id=['pr','tas'],frequency='mon',member_id='r1i1p1f1')",
        ">>> print(cat)",
